...
`tokens` has many useful options (check out `?tokens` for more information). Let's actually use it to stem the text, extract n-grams, remove punctuation, keep Twitter features...
